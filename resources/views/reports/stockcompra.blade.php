...
<div class="container">  
    <form method="POST" action="{{ route('stockcompra.store') }}">
        @csrf 
        <div class="row mt-4 justify-content-center">
            <div class="col-md-4">
                <div class="container border rounded">
                    ...
                    <div class="mb-2 row d-flex justify-content-center">
                        ...
                        <div class="col-sm-7">
                            <input id="fecha_fin" type="date" class="form-control form-control-sm"  
                                @if(!Auth::user()->tienePermiso(38,6)) 
                                    disabled
                                @endif 
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-12 text-center d-block gap-2">
                            ...
                            @if(Auth::user()->tienePermiso(38, 12))
                ...
                <div class="controles-form-esq-der  @if(!Auth::user()->tienePermiso(38,9)) d-none @endif">
            ...
            <div class="col-8
            @if(!Auth::user()->tienePermiso(38,9))
                d-none
            @endif">
