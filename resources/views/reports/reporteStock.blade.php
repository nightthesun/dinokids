...
<div class="container">
  <form method="POST" action="{{ route('reporteStock.store') }}">
    @csrf
              ...
              <div id="flush-collapseTwo23" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo23" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <div class="row p-2" style="height:35vh;overflow:auto; font-size:0.8rem">
                    ...
                    @foreach($alm as $l => $a)
                    @if ($a->inalmNomb=="INSUMOS"||$a->inalmNomb=="MATERIA PRIMA"||$a->inalmNomb=="PRODUCCION EN PROCESO"||$a->inalmNomb=="PRODUCTO TERMINADO")
                    <div class="form-check form-switch">
...
<script>
  $(document).ready(function() {
    $(".usuarios_param").click(function() {
      ...
      $.ajax({
        url: "{{route('reporteStock.store_almxu')}}",
        type: 'POST',
        data: {
          user,
          show: true
