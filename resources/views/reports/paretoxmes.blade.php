...
<div class="container">
  <div class="row justify-content-center mt-4">
    <div class="col-md-8 col-lg-6 col-sm-12 border">
      <form method="POST" action="{{ route('paretoxmes.store') }}">
        @csrf
        <div class=" row d-flex justify-content-center my-3">
          <div class="d-flex align-items-center justify-content-center">
            <h3 class="text-primary">REPORTE MES/PARETO VENTAS</h3>
          </div>
        </div>
            ...
            <div class="mb-3 row d-flex justify-content-center">
              ...
              <div class="col-sm-6">
                <select class="form-select" aria-label="Default select example" name="categoria">
                  ...
                  <option value="LEYDEZ">LEYDEZ</option>
                  <option value="LEYDEZ - PEALTO">LEYDEZ - PEALTO</option>
                  <option value="USING">USING</option>
                  <option value="PEGAFAN">PEGAFAN</option>
        ...
        <div class="mb-3 row">
          <div class="col-md-12 d-flex justify-content-center">
            ...
            @if (Auth::user()->tienePermiso(42, 12))
