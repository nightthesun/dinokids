...
<div class="container">
  <form method="POST" action="{{ route('listaPrecio.store') }}">
    @csrf
      ...
      <div class="col-md-4">
        ...
        <div class="container border rounded">
          <div class="row text-center my-3">
            <h5 class="text-primary">LISTA DE PRECIOS</h5>
          </div>
          ...
          <div class="mb-3 row">
            <div class="col-md-12 text-center d-block gap-2">
              ...
              @if(Auth::user()->tienePermiso(34, 12))
...
@endif">
      ...
      <div class="row row-cols-1 row-cols-lg-5 g-2 g-lg-3 d-none">
        <div class="col">
                    ...
                    <div class="row p-2" style="height:35vh;overflow:auto; font-size:0.8rem">
                      ...
                      <div class="col-8 px-100 py-6 ">
                        ...
                        <ul id="seg" class="list-group list-group-flush">
                          ...
                          <li class="list-group-item" id="{{$k}}">
                            <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox" id="{{$a->inalmCalm}}" value="{{$a->inalmCalm}}" name="almacen[]" @if($a->estado == 1)
                              checked @endif>
                              <label class="form-check-label" for="flexSwitchCheckChecked">
                                {{$a->inalmNomb}}
                              </label>
