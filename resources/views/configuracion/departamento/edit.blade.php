...
@if(Auth::user()->authorizepermisos(['Departamento', 'Ver']) && Auth::user()->authorizepermisos(['Departamento', 'Crear']) )
...
<div style="padding: 6rem; padding-top:0.5rem;">
  <div class="row d-flex justify-content-center mb-3">
    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
      <h3 class="text-center titulo1">Editar de departamento</h3>
      <a href="{{ url('/') }}">
  ...
  <form method="POST" enctype="multipart/form-data" action="{{ route('departamento.update',$department[0]->id) }}">
    @csrf
    <div class="row">
...
<div class="row">
  <div class="col-6">
          ...
          <input id="name" type="text" value="{{$department[0]->name}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
            @error('name')
  ...
  <div class="col-6">
          ...
          <input id="descripcion" type="text" value="{{$department[0]->description}}" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" value="{{ old('descripcion') }}" autocomplete="descripcion">
            @error('descripcion')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
