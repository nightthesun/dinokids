...
<div style="padding: 6rem; padding-top:0.5rem;">
  ...
  <form method="POST" enctype="multipart/form-data" action="{{ route('programa.store') }}">
    @csrf
    <div class="row">
  ...
  <table class="table table-striped table-hover"  id="table2">
    <thead class="thead">
      ...
      <tbody >
        <tr>
          <td>
            <input class="form-control" type="text" name="numberCell[]" placeholder="programa" required>
          </td>
          <td>
            <input class="form-control" type="text" name="description[]" placeholder="resumen del programa">
          </td>
        </tr>
      </tbody>
  </table>
