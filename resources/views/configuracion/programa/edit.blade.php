...
@if(Auth::user()->authorizepermisos(['Programa', 'Ver']) && Auth::user()->authorizepermisos(['Programa', 'Crear']) )
...
<div style="padding: 6rem; padding-top:0.5rem;">
  <div class="row d-flex justify-content-center mb-3">
    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
      <h3 class="text-center titulo1">Registro de programas</h3>
      <a href="{{ url('/') }}">
  ...
  <form method="POST" enctype="multipart/form-data" action="{{ route('programa.update',$programa[0]->id) }}">
    @csrf
    <div class="row">
...
<h3 style="padding-top: 10px">Datos de programa</h3>
  ...
  <table class="table table-striped table-hover"  id="table2">
    <thead class="thead">
      ...
      <tbody >
        <tr>
          <td>
            <input class="form-control" value="{{$programa[0]->interventionarea_name}}" valoe type="text" name="numberCell" placeholder="programa" required>
          </td>
          <td>
            <input class="form-control" value="{{$programa[0]->interventionarea_description}}" type="text" name="description" placeholder="resumen del programa">
          </td>
        </tr>
      </tbody>
  </table>
...
function alertaAceptar(){
  new novaAlert({
    icon: 'success',
    title: 'Actualización de programa correcto',
