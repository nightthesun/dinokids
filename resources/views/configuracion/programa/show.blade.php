...
@if(Auth::user()->authorizepermisos(['Sucursal', 'Ver']) && Auth::user()->authorizepermisos(['Programa', 'Ver informacion']) )
...
<div style="padding: 6rem; padding-top:0.5rem;">
  <div class="row d-flex justify-content-center mb-3">
    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
      <h3 class="text-center titulo1">Programa {{$programa[0]->interventionarea_name}}</h3>
      <a href="{{ url('/') }}">
    ...
    <div class="row">
      ...
      <div class="col-12 borde1">
        <h3 class="mt-3">Datos de programa</h3>
  ...
  <div class="col">
    <div class="card" >
        <div class="card-body">
          ...
          <p class="card-text">{{$programa[0]->interventionarea_description}}</p>
  ...
  <div class="col">
    ...
    <div class="card" >
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">Fecha: {{$programa[0]->creaF}}</h6>
          <p class="card-text">Usuario: {{$programa[0]->creaU}}</p>
...
<div class="col">
    <div class="card" >
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">Fecha: {{$programa[0]->modiF}}</h6>
          <p class="card-text">Usuario: {{$programa[0]->modiU}}</p>
...
<div class="col">
    ...
    <div class="card" >
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">Fecha: {{$programa[0]->eliF}}</h6>
          <p class="card-text">Usuario: {{$programa[0]->eliU}}</p>
