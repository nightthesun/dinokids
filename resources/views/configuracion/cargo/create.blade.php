...
<div style="padding: 6rem; padding-top:0.5rem;">
  <div class="row d-flex justify-content-center mb-3">
    <div class="col-lg-6 col-sm-12 d-flex align-items-center justify-content-center">
      <h3 class="text-center titulo1">Registro de cargo</h3>
      <a href="{{ url('/') }}">
  ...
  <form method="POST" enctype="multipart/form-data" action="{{ route('cargo.store') }}">
    @csrf
    <div class="row">
      

      <div class="col-12 borde1">
        <h3 class="mt-3">Datos de cargos</h3>
...
<div class="row">
  ...
  <div class="col">
    ...
    <input id="salary" type="text" inputmode="decimal" id="float-input" pattern="[0-9]*[.,]?[0-9]*" class="form-control  @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary') }}" autocomplete="salary">
      @error('salary')
      <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
      </span>
